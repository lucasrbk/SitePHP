<?php
   ...
   $daof->cadastrarFuncionario($objetoFuncionario, $_REQUEST['cargo']); //basta apenas passar o código do cargo, não precisa criar um objeto cargo para inserir esse objeto na classe Funcionario, pois para cadastrar no banco só precisamos da informação do código
