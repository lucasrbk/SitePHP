      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="view_funcionario.php">Funcion·rios</a></li>
		...
		<fieldset>
		  	...
		  	<div class="form-group">	
			    ...
			    <select name="status">
					  ...
					  <option value="FÈrias">FÈrias</option>
					  <option value="LicenÁa mÈdica">Licen√ßa m√©dica</option>
				</select>
			</div>
...
<div class="container">
  <div class="panel panel-default">
  		<div class="panel-heading">
    		<h2 class="panel-title">Lista de Funcion√°rios</h2>
